...
type CombatUnitStats struct {
	...
	// Radius is the collision radius in 12.4 fixed-point tiles (ADR-0030).
	// Replicated to CollisionComponent at spawn so the collision loop avoids
