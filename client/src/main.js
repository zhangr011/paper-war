...
import { effectiveRange, elevationAt, ringTriangles } from './range_ring.js?v=v8';
...
export class Game {
  ...
  render() {
    ...
    const rangeRings = this.buildRangeRings();
  ...
  buildRangeRings() {
    ...
    for (const unit of this.selectedUnits) {
      ...
      const { base, max } = effectiveRange(unit.unitType, elev);
